...
LastEditTime : 2024-04-05 23:45:36
FilePath     : /NL2GQL/System.py
Description  : 
...
if __name__ == '__main__':
    ...
    dict ={"prompt": "Can you help me find the player information with name '鲁迅'?", 
           "content": "MATCH (n:player) WHERE id(n) == \"Boris Diaw\" RETURN n;", 
           ...
           "class":"nba",
           "result": ["[(\"Boris Diaw\" :player{age: 36, name: \"Boris Diaw\"})]"]}
